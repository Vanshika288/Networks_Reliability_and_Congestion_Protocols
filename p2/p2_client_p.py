...
def make_ack_packet(cum_ack, ts_echo, sack_block):
    ...
    sack_block: A tuple (start, end) for the first SACK block, or (0, 0) if none.
    """
...
def run_client(server_ip, server_port, filename_prefix):
    """Main client logic."""
    global expected_seq
    ...
    # Output filename
    outfile = f"{filename_prefix}received_data.txt"
