...
CONGESTION_EPISODE = True
NEXT_SEQ_EPISODE_END = None
...
def process_ack(ack_packet):
    ...
    global NEXT_SEQ_EPISODE_END , CONGESTION_EPISODE
    ...
    with state_lock:
        ...
        if cum_ack > base_seq:
            ...
            old_base = base_seq
            base_seq = cum_ack
            if CONGESTION_EPISODE == False and base_seq == NEXT_SEQ_EPISODE_END:
                CONGESTION_EPISODE = True
            ...
            if base_seq in in_flight_packets:
                ...
                if dup_ack_counts[cum_ack] == 3 + FAST_RETRANSMIT_K * retrans_count:
                    ...
                    if CONGESTION_EPISODE:
                        CONGESTION_EPISODE = False
                        NEXT_SEQ_EPISODE_END = next_seq
...
def run_server(server_ip, server_port, output_prefix="p2_server"):
    ...
    global CONGESTION_EPISODE, NEXT_SEQ_EPISODE_END
    ...
    while base_seq < file_size:
        with state_lock:
            ...
            if len(packets_to_retransmit) > 0 and CONGESTION_EPISODE:
                CONGESTION_EPISODE = False
                NEXT_SEQ_EPISODE_END = next_seq
